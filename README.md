...
4. Собрать `Knowledge ingestion workflow` и загрузить FAQ/price list.
5. Собрать `Telegram bot workflow`.
6. Собрать `Lead capture workflow`.
7. Собрать `Web chat workflow`.
